...
console.log(errorCentre);
  ...
  const { isLoading: loadingParams, error: errorParams, data: paramsData, isFetching: isCentreFetching,  refetch } = useQuery(
    'centreParams',
    () => fetch('http://localhost:8080/params').then(res => res.json()),
    { enabled: false }
  );
